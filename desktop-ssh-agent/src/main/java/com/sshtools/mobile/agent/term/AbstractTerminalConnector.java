...
public abstract class AbstractTerminalConnector {
	 ...
	 *            the terminal
	 */
	public AbstractTerminalConnector(MobileAgent agent, JsonConnection serverConnection) {
		this.agent = agent;
	...
	public AbstractTerminalConnector(MobileAgent agent, String serverName, int serverPort, String username) {
		this.agent = agent;
